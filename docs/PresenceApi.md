...
public class Example {
    public static void main(String[] args) {
        ...
        ServiceVOIPPresenceSetResetEditData reqBody = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPPresenceSetResetEditData(); // ServiceVOIPPresenceSetResetEditData | payload fields
        try {
