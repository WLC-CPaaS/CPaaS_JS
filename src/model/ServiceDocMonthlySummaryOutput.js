...
public class ServiceDocMonthlySummaryOutput {
  ...
  public ServiceDocMonthlySummaryOutput pageSize(@.annotation.Nullable Number pageSize) {
  ...
  public ServiceDocMonthlySummaryOutput statusCode(@.annotation.Nullable Number statusCode) {
