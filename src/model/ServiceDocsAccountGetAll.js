...
public class ServiceDocsAccountGetAll {
  ...
  public ServiceDocsAccountGetAll pageSize(@.annotation.Nullable Number pageSize) {
  ...
  public ServiceDocsAccountGetAll statusCode(@.annotation.Nullable Number statusCode) {
