 ...
 * @module model/ServiceDocsCallparkGet
 * @version 1.1
 */
class ServiceDocsCallparkGet {
    /**
     * Constructs a new <code>ServiceDocsCallparkGet</code>.
     * @alias module:model/ServiceDocsCallparkGet
     */
    constructor() { 
        
        ServiceDocsCallparkGet.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServiceDocsCallparkGet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServiceDocsCallparkGet} obj Optional instance to populate.
     * @return {module:model/ServiceDocsCallparkGet} The populated <code>ServiceDocsCallparkGet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServiceDocsCallparkGet();
    ...
    /**
     * Validates the JSON data with respect to <code>ServiceDocsCallparkGet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServiceDocsCallparkGet</code>.
     */
 ...
 */
ServiceDocsCallparkGet.prototype['next_start_key'] = undefined;

/**
 * List Pagination: The number of results returned in this page
 * @member {Number} page_size
 */
ServiceDocsCallparkGet.prototype['page_size'] = undefined;

/**
 * Unique id for each request
 * @member {String} request_id
 */
ServiceDocsCallparkGet.prototype['request_id'] = undefined;

/**
 * List Pagination: Code for paged results
 * @member {String} start_key
 */
ServiceDocsCallparkGet.prototype['start_key'] = undefined;

/**
 * HTTP response status code
 * @member {Number} status_code
 */
ServiceDocsCallparkGet.prototype['status_code'] = undefined;
...
export default ServiceDocsCallparkGet;
