...
public class ServiceVOIPStorageAddEditData {
  ...
  public ServiceVOIPStorageAddEditData attachments(@.annotation.Nullable {String: Object} attachments) {
  ...
  public ServiceVOIPStorageAddEditData connections(@.annotation.Nullable {String: Object} connections) {
