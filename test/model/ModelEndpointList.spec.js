...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelEndpointList();
  });
  ...
  describe('ModelEndpointList', function() {
    it('should create an instance of ModelEndpointList', function() {
      // uncomment below and update the code to test ModelEndpointList
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelEndpointList();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ModelEndpointList);
    });
    ...
    it('should have the property endpointName (base name: "endpoint_name")', function() {
