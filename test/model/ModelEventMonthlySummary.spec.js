...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelEventMonthlySummary();
  });
  ...
  describe('ModelEventMonthlySummary', function() {
    it('should create an instance of ModelEventMonthlySummary', function() {
      // uncomment below and update the code to test ModelEventMonthlySummary
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelEventMonthlySummary();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ModelEventMonthlySummary);
    });
