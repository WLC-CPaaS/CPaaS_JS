...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsAccountOutputFull();
  });
  ...
  describe('ModelsAccountOutputFull', function() {
    it('should create an instance of ModelsAccountOutputFull', function() {
      // uncomment below and update the code to test ModelsAccountOutputFull
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsAccountOutputFull();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ModelsAccountOutputFull);
    });
