...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsCallRecordingSettings();
  });
  ...
  describe('ModelsCallRecordingSettings', function() {
    it('should create an instance of ModelsCallRecordingSettings', function() {
      // uncomment below and update the code to test ModelsCallRecordingSettings
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsCallRecordingSettings();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ModelsCallRecordingSettings);
    });
