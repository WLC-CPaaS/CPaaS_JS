...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsCallRecordingSource();
  });
  ...
  describe('ModelsCallRecordingSource', function() {
    it('should create an instance of ModelsCallRecordingSource', function() {
      // uncomment below and update the code to test ModelsCallRecordingSource
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsCallRecordingSource();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ModelsCallRecordingSource);
    });
