...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsDeviceOutputFullCallerid();
  });
  ...
  describe('ModelsDeviceOutputFullCallerid', function() {
    it('should create an instance of ModelsDeviceOutputFullCallerid', function() {
      // uncomment below and update the code to test ModelsDeviceOutputFullCallerid
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsDeviceOutputFullCallerid();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ModelsDeviceOutputFullCallerid);
    });
