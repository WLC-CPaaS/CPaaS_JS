...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsUserOutputFull();
  });
  ...
  describe('ModelsUserOutputFull', function() {
    it('should create an instance of ModelsUserOutputFull', function() {
      // uncomment below and update the code to test ModelsUserOutputFull
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsUserOutputFull();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ModelsUserOutputFull);
    });
