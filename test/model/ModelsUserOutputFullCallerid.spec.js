...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsUserOutputFullCallerid();
  });
  ...
  describe('ModelsUserOutputFullCallerid', function() {
    it('should create an instance of ModelsUserOutputFullCallerid', function() {
      // uncomment below and update the code to test ModelsUserOutputFullCallerid
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsUserOutputFullCallerid();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ModelsUserOutputFullCallerid);
    });
