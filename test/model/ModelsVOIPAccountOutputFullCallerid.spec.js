...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsVOIPAccountOutputFullCallerid();
  });
  ...
  describe('ModelsVOIPAccountOutputFullCallerid', function() {
    it('should create an instance of ModelsVOIPAccountOutputFullCallerid', function() {
      // uncomment below and update the code to test ModelsVOIPAccountOutputFullCallerid
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ModelsVOIPAccountOutputFullCallerid();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ModelsVOIPAccountOutputFullCallerid);
    });
