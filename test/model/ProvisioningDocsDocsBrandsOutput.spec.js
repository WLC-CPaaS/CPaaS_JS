...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsBrandsOutput();
  });
  ...
  describe('ProvisioningDocsDocsBrandsOutput', function() {
    it('should create an instance of ProvisioningDocsDocsBrandsOutput', function() {
      // uncomment below and update the code to test ProvisioningDocsDocsBrandsOutput
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsBrandsOutput();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsBrandsOutput);
    });
