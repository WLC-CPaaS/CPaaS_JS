...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsConfigFileOutput();
  });
  ...
  describe('ProvisioningDocsDocsConfigFileOutput', function() {
    it('should create an instance of ProvisioningDocsDocsConfigFileOutput', function() {
      // uncomment below and update the code to test ProvisioningDocsDocsConfigFileOutput
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsConfigFileOutput();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsConfigFileOutput);
    });
