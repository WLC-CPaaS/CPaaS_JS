...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsFamilyOutput();
  });
  ...
  describe('ProvisioningDocsDocsFamilyOutput', function() {
    it('should create an instance of ProvisioningDocsDocsFamilyOutput', function() {
      // uncomment below and update the code to test ProvisioningDocsDocsFamilyOutput
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsFamilyOutput();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsFamilyOutput);
    });
