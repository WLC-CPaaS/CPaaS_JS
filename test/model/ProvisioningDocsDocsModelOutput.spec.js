...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsModelOutput();
  });
  ...
  describe('ProvisioningDocsDocsModelOutput', function() {
    it('should create an instance of ProvisioningDocsDocsModelOutput', function() {
      // uncomment below and update the code to test ProvisioningDocsDocsModelOutput
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsModelOutput();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsModelOutput);
    });
