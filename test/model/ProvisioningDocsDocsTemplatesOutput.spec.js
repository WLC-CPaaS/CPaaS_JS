...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsTemplatesOutput();
  });
  ...
  describe('ProvisioningDocsDocsTemplatesOutput', function() {
    it('should create an instance of ProvisioningDocsDocsTemplatesOutput', function() {
      // uncomment below and update the code to test ProvisioningDocsDocsTemplatesOutput
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsTemplatesOutput();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ProvisioningDocsDocsTemplatesOutput);
    });
