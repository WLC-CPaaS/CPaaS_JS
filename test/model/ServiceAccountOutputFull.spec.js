...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceAccountOutputFull();
  });
  ...
  describe('ServiceAccountOutputFull', function() {
    it('should create an instance of ServiceAccountOutputFull', function() {
      // uncomment below and update the code to test ServiceAccountOutputFull
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceAccountOutputFull();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceAccountOutputFull);
    });
