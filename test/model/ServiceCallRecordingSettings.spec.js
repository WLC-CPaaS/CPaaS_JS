...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceCallRecordingSettings();
  });
  ...
  describe('ServiceCallRecordingSettings', function() {
    it('should create an instance of ServiceCallRecordingSettings', function() {
      // uncomment below and update the code to test ServiceCallRecordingSettings
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceCallRecordingSettings();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceCallRecordingSettings);
    });
