...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceCallflowOutputShort();
  });
  ...
  describe('ServiceCallflowOutputShort', function() {
    it('should create an instance of ServiceCallflowOutputShort', function() {
      // uncomment below and update the code to test ServiceCallflowOutputShort
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceCallflowOutputShort();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceCallflowOutputShort);
    });
