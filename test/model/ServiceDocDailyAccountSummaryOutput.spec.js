...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocDailyAccountSummaryOutput();
  });
  ...
  describe('ServiceDocDailyAccountSummaryOutput', function() {
    it('should create an instance of ServiceDocDailyAccountSummaryOutput', function() {
      // uncomment below and update the code to test ServiceDocDailyAccountSummaryOutput
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocDailyAccountSummaryOutput();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocDailyAccountSummaryOutput);
    });
