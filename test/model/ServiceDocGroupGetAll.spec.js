...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocGroupGetAll();
  });
  ...
  describe('ServiceDocGroupGetAll', function() {
    it('should create an instance of ServiceDocGroupGetAll', function() {
      // uncomment below and update the code to test ServiceDocGroupGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocGroupGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocGroupGetAll);
    });
