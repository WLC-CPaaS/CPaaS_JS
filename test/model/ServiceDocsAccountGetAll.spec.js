...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsAccountGetAll();
  });
  ...
  describe('ServiceDocsAccountGetAll', function() {
    it('should create an instance of ServiceDocsAccountGetAll', function() {
      // uncomment below and update the code to test ServiceDocsAccountGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsAccountGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsAccountGetAll);
    });
