...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsAccountPhonenumberGetAll();
  });
  ...
  describe('ServiceDocsAccountPhonenumberGetAll', function() {
    it('should create an instance of ServiceDocsAccountPhonenumberGetAll', function() {
      // uncomment below and update the code to test ServiceDocsAccountPhonenumberGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsAccountPhonenumberGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsAccountPhonenumberGetAll);
    });
