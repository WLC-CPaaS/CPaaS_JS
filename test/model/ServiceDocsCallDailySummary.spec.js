...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallDailySummary();
  });
  ...
  describe('ServiceDocsCallDailySummary', function() {
    it('should create an instance of ServiceDocsCallDailySummary', function() {
      // uncomment below and update the code to test ServiceDocsCallDailySummary
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallDailySummary();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallDailySummary);
    });
