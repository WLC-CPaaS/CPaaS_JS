...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallDetail();
  });
  ...
  describe('ServiceDocsCallDetail', function() {
    it('should create an instance of ServiceDocsCallDetail', function() {
      // uncomment below and update the code to test ServiceDocsCallDetail
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallDetail();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallDetail);
    });
