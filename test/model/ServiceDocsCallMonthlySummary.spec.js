...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallMonthlySummary();
  });
  ...
  describe('ServiceDocsCallMonthlySummary', function() {
    it('should create an instance of ServiceDocsCallMonthlySummary', function() {
      // uncomment below and update the code to test ServiceDocsCallMonthlySummary
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallMonthlySummary();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallMonthlySummary);
    });
