...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallQueueGetAll();
  });
  ...
  describe('ServiceDocsCallQueueGetAll', function() {
    it('should create an instance of ServiceDocsCallQueueGetAll', function() {
      // uncomment below and update the code to test ServiceDocsCallQueueGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallQueueGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallQueueGetAll);
    });
