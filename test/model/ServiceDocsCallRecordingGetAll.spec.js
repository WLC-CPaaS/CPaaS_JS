...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallRecordingGetAll();
  });
  ...
  describe('ServiceDocsCallRecordingGetAll', function() {
    it('should create an instance of ServiceDocsCallRecordingGetAll', function() {
      // uncomment below and update the code to test ServiceDocsCallRecordingGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallRecordingGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallRecordingGetAll);
    });
