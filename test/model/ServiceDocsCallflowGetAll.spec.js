...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallflowGetAll();
  });
  ...
  describe('ServiceDocsCallflowGetAll', function() {
    it('should create an instance of ServiceDocsCallflowGetAll', function() {
      // uncomment below and update the code to test ServiceDocsCallflowGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallflowGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallflowGetAll);
    });
