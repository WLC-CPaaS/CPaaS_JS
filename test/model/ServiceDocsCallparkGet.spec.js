...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallparkGet();
  });
  ...
  describe('ServiceDocsCallparkGet', function() {
    it('should create an instance of ServiceDocsCallparkGet', function() {
      // uncomment below and update the code to test ServiceDocsCallparkGet
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallparkGet();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCallparkGet);
    });
