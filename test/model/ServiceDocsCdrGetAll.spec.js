...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCdrGetAll();
  });
  ...
  describe('ServiceDocsCdrGetAll', function() {
    it('should create an instance of ServiceDocsCdrGetAll', function() {
      // uncomment below and update the code to test ServiceDocsCdrGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCdrGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsCdrGetAll);
    });
