...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsDeviceGetAll();
  });
  ...
  describe('ServiceDocsDeviceGetAll', function() {
    it('should create an instance of ServiceDocsDeviceGetAll', function() {
      // uncomment below and update the code to test ServiceDocsDeviceGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsDeviceGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsDeviceGetAll);
    });
