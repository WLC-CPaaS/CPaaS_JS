...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsDeviceStatus();
  });
  ...
  describe('ServiceDocsDeviceStatus', function() {
    it('should create an instance of ServiceDocsDeviceStatus', function() {
      // uncomment below and update the code to test ServiceDocsDeviceStatus
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsDeviceStatus();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsDeviceStatus);
    });
