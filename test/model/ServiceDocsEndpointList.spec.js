...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsEndpointList();
  });
  ...
  describe('ServiceDocsEndpointList', function() {
    it('should create an instance of ServiceDocsEndpointList', function() {
      // uncomment below and update the code to test ServiceDocsEndpointList
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsEndpointList();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsEndpointList);
    });
