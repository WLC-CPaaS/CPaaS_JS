...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsEventDailySummary();
  });
  ...
  describe('ServiceDocsEventDailySummary', function() {
    it('should create an instance of ServiceDocsEventDailySummary', function() {
      // uncomment below and update the code to test ServiceDocsEventDailySummary
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsEventDailySummary();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsEventDailySummary);
    });
