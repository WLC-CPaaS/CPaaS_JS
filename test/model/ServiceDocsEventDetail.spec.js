...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsEventDetail();
  });
  ...
  describe('ServiceDocsEventDetail', function() {
    it('should create an instance of ServiceDocsEventDetail', function() {
      // uncomment below and update the code to test ServiceDocsEventDetail
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsEventDetail();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsEventDetail);
    });
