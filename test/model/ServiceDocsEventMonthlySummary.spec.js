...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsEventMonthlySummary();
  });
  ...
  describe('ServiceDocsEventMonthlySummary', function() {
    it('should create an instance of ServiceDocsEventMonthlySummary', function() {
      // uncomment below and update the code to test ServiceDocsEventMonthlySummary
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsEventMonthlySummary();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsEventMonthlySummary);
    });
