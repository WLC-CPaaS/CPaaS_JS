...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsFeatureDailySummary();
  });
  ...
  describe('ServiceDocsFeatureDailySummary', function() {
    it('should create an instance of ServiceDocsFeatureDailySummary', function() {
      // uncomment below and update the code to test ServiceDocsFeatureDailySummary
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsFeatureDailySummary();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsFeatureDailySummary);
    });
