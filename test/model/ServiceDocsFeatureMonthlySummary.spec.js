...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsFeatureMonthlySummary();
  });
  ...
  describe('ServiceDocsFeatureMonthlySummary', function() {
    it('should create an instance of ServiceDocsFeatureMonthlySummary', function() {
      // uncomment below and update the code to test ServiceDocsFeatureMonthlySummary
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsFeatureMonthlySummary();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsFeatureMonthlySummary);
    });
