...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsGetQueueRecipients();
  });
  ...
  describe('ServiceDocsGetQueueRecipients', function() {
    it('should create an instance of ServiceDocsGetQueueRecipients', function() {
      // uncomment below and update the code to test ServiceDocsGetQueueRecipients
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsGetQueueRecipients();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsGetQueueRecipients);
    });
