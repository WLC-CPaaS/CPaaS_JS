...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsMediaGetAll();
  });
  ...
  describe('ServiceDocsMediaGetAll', function() {
    it('should create an instance of ServiceDocsMediaGetAll', function() {
      // uncomment below and update the code to test ServiceDocsMediaGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsMediaGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsMediaGetAll);
    });
