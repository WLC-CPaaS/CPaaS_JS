...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsMenuGetAll();
  });
  ...
  describe('ServiceDocsMenuGetAll', function() {
    it('should create an instance of ServiceDocsMenuGetAll', function() {
      // uncomment below and update the code to test ServiceDocsMenuGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsMenuGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsMenuGetAll);
    });
