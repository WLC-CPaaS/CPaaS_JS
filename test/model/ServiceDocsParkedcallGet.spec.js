...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsParkedcallGet();
  });
  ...
  describe('ServiceDocsParkedcallGet', function() {
    it('should create an instance of ServiceDocsParkedcallGet', function() {
      // uncomment below and update the code to test ServiceDocsParkedcallGet
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsParkedcallGet();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsParkedcallGet);
    });
