...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsTemporalRuleGetAll();
  });
  ...
  describe('ServiceDocsTemporalRuleGetAll', function() {
    it('should create an instance of ServiceDocsTemporalRuleGetAll', function() {
      // uncomment below and update the code to test ServiceDocsTemporalRuleGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsTemporalRuleGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsTemporalRuleGetAll);
    });
