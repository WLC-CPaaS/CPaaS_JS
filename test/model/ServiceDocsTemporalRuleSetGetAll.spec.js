...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsTemporalRuleSetGetAll();
  });
  ...
  describe('ServiceDocsTemporalRuleSetGetAll', function() {
    it('should create an instance of ServiceDocsTemporalRuleSetGetAll', function() {
      // uncomment below and update the code to test ServiceDocsTemporalRuleSetGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsTemporalRuleSetGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsTemporalRuleSetGetAll);
    });
