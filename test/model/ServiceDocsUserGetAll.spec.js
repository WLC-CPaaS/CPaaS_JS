...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsUserGetAll();
  });
  ...
  describe('ServiceDocsUserGetAll', function() {
    it('should create an instance of ServiceDocsUserGetAll', function() {
      // uncomment below and update the code to test ServiceDocsUserGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsUserGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsUserGetAll);
    });
