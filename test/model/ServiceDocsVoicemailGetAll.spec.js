...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsVoicemailGetAll();
  });
  ...
  describe('ServiceDocsVoicemailGetAll', function() {
    it('should create an instance of ServiceDocsVoicemailGetAll', function() {
      // uncomment below and update the code to test ServiceDocsVoicemailGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsVoicemailGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsVoicemailGetAll);
    });
