...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsVoicemailMessageGetAll();
  });
  ...
  describe('ServiceDocsVoicemailMessageGetAll', function() {
    it('should create an instance of ServiceDocsVoicemailMessageGetAll', function() {
      // uncomment below and update the code to test ServiceDocsVoicemailMessageGetAll
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsVoicemailMessageGetAll();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceDocsVoicemailMessageGetAll);
    });
