...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceStoragePlanDatabase();
  });
  ...
  describe('ServiceStoragePlanDatabase', function() {
    it('should create an instance of ServiceStoragePlanDatabase', function() {
      // uncomment below and update the code to test ServiceStoragePlanDatabase
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceStoragePlanDatabase();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceStoragePlanDatabase);
    });
