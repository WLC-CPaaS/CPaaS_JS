...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceUserOutputFull();
  });
  ...
  describe('ServiceUserOutputFull', function() {
    it('should create an instance of ServiceUserOutputFull', function() {
      // uncomment below and update the code to test ServiceUserOutputFull
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceUserOutputFull();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceUserOutputFull);
    });
