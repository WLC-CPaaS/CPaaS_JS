...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceUserOutputFullCallerid();
  });
  ...
  describe('ServiceUserOutputFullCallerid', function() {
    it('should create an instance of ServiceUserOutputFullCallerid', function() {
      // uncomment below and update the code to test ServiceUserOutputFullCallerid
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceUserOutputFullCallerid();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceUserOutputFullCallerid);
    });
