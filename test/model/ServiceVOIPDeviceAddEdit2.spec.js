...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPDeviceAddEdit2();
  });
  ...
  describe('ServiceVOIPDeviceAddEdit2', function() {
    it('should create an instance of ServiceVOIPDeviceAddEdit2', function() {
      // uncomment below and update the code to test ServiceVOIPDeviceAddEdit2
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPDeviceAddEdit2();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPDeviceAddEdit2);
    });
