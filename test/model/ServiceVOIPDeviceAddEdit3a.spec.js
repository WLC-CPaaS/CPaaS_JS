...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPDeviceAddEdit3a();
  });
  ...
  describe('ServiceVOIPDeviceAddEdit3a', function() {
    it('should create an instance of ServiceVOIPDeviceAddEdit3a', function() {
      // uncomment below and update the code to test ServiceVOIPDeviceAddEdit3a
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPDeviceAddEdit3a();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPDeviceAddEdit3a);
    });
