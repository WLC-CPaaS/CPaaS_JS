...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPMetaflowAddData();
  });
  ...
  describe('ServiceVOIPMetaflowAddData', function() {
    it('should create an instance of ServiceVOIPMetaflowAddData', function() {
      // uncomment below and update the code to test ServiceVOIPMetaflowAddData
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPMetaflowAddData();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPMetaflowAddData);
    });
