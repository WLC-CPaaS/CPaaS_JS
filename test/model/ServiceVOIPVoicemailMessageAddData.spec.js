...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPVoicemailMessageAddData();
  });
  ...
  describe('ServiceVOIPVoicemailMessageAddData', function() {
    it('should create an instance of ServiceVOIPVoicemailMessageAddData', function() {
      // uncomment below and update the code to test ServiceVOIPVoicemailMessageAddData
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPVoicemailMessageAddData();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVOIPVoicemailMessageAddData);
    });
