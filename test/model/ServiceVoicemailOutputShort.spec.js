...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVoicemailOutputShort();
  });
  ...
  describe('ServiceVoicemailOutputShort', function() {
    it('should create an instance of ServiceVoicemailOutputShort', function() {
      // uncomment below and update the code to test ServiceVoicemailOutputShort
      //var instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVoicemailOutputShort();
      //expect(instance).to.be.a(WhiteLabelCommunicationsCPaasApiDocumentation.ServiceVoicemailOutputShort);
    });
