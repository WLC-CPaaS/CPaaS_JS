...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhiteLabelCommunicationsCPaasApiDocumentation.ServiceWebhookEdit();
  });
  ...
  describe('ServiceWebhookEdit', function() {
    it('should create an instance of ServiceWebhookEdit', function() {
      // uncomment below and update the code to test ServiceWebhookEdit
